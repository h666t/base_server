...
var apiPathList = [];
var apiFilePath = path_1.default.resolve(__dirname, "../../api");
console.log(apiFilePath);
var router = new koa_router_1.default();
router.prefix("/api");
var prepareApiFile = function (filePath) { return __awaiter(void 0, void 0, void 0, function () {
    var files, _loop_1, i;
...
var initAPI = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, prepareApiFile(apiFilePath)];
            case 1:
                _a.sent();
